...
// ExistsAlias provides a mock function with given fields: alias
func (_m *URLSaver) ExistsAlias(alias string) (bool, error) {
	ret := _m.Called(alias)

	if len(ret) == 0 {
		panic("no return value specified for ExistsAlias")
	}
